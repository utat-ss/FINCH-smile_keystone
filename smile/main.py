...
if __name__ == '__main__':
  ...
  ref_spectra, test_spectra = create_ref_and_test_spectra((0,1000), demo_SRF, column_averaged_spectra, wavelength, g_num_of_bands, g_num_shifts_1D, g_shift_increment) # Step 3, 4: Generate Reference and Test spectra. (0,100) is also a placeholder
