...
log_message(f"Import Step: Load and crop Indian Pine data - {step_end - step_start:.4f} seconds")
...
step_end = timeit.default_timer()
log_message(f"Import Step: Load and crop MODTRAN data - {step_end - step_start:.4f} seconds")
