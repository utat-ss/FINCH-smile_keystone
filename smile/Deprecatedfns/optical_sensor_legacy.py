...
class optical_sensor:
    ...
    def __init__(self, data_input, sensor_number:int, spectral_response_function1, shift_constant):
        ...
        sensor_width = len(config.wavelength_input) / config.num_of_bands
        ...
        print(f'x_left_bound: {sensor_number * sensor_width}, {self.x_left_bound}, x_right_bound: {(1 + sensor_number) * sensor_width}, {self.x_right_bound}')        
